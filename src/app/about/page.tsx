    ...
    <div className="py-20 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <section className="mb-20">
          <h2 className="text-2xl font-bold mb-6 dark:text-white">소개</h2>
          <div className="space-y-4 text-lg leading-relaxed text-gray-700 dark:text-gray-300">
            ...
            <p>
              ...
              있습니다. 그동안의 프로젝트 경험에 최신 트렌드를 접목해 더욱
              견고한 프론트엔드 환경을 구축하고자 합니다.
            </p>
          </div>
        </section>
        ...
        {/* 경력 타임라인 */}
        <section className="mb-20">
          <h2 className="text-2xl font-bold mb-8 dark:text-white">경력</h2>
          <div className="space-y-8">
            {[
              ...
              <div key={i} className="flex gap-8">
                ...
                <div className="flex-1 relative pb-8 border-l-2 border-gray-200 dark:border-gray-800 pl-8">
        ...
        {/* 기술 스택 */}
        <section className="mb-20">
          <h2 className="text-2xl font-bold mb-8 dark:text-white">기술 스택</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div>
              <h3 className="font-bold text-lg mb-4 text-purple-600 dark:text-purple-400">
                Integration
              </h3>
              <ul className="space-y-2">
